# Graph Report - /mnt/data/dev/ai-search-transcripts/.  (2026-04-10)

## Corpus Check
- 149 files · ~191,818 words
...
- `enrich_transcript()` --calls--> `extract_entities()`  [INFERRED]
  /mnt/data/dev/ai-search-transcripts/scripts/enrich.py → /mnt/data/dev/ai-search-transcripts/scripts/enrich.py  _Bridges community 9 → community 5_
- `enrich_transcript()` --calls--> `classify_topic()`  [INFERRED]
  /mnt/data/dev/ai-search-transcripts/scripts/enrich.py → /mnt/data/dev/ai-search-transcripts/scripts/enrich.py  _Bridges community 10 → community 5_
- `enrich_transcript()` --calls--> `classify_difficulty()`  [INFERRED]
  /mnt/data/dev/ai-search-transcripts/scripts/enrich.py → /mnt/data/dev/ai-search-transcripts/scripts/enrich.py  _Bridges community 12 → community 5_
- `enrich_transcript()` --calls--> `classify_audience()`  [INFERRED]
  /mnt/data/dev/ai-search-transcripts/scripts/enrich.py → /mnt/data/dev/ai-search-transcripts/scripts/enrich.py  _Bridges community 6 → community 5_
- `enrich_transcript()` --calls--> `extract_concepts()`  [INFERRED]
  /mnt/data/dev/ai-search-transcripts/scripts/enrich.py → /mnt/data/dev/ai-search-transcripts/scripts/enrich.py  _Bridges community 8 → community 5_
...
Cohesion: 0.5
Nodes (4): classify_content_type(), enrich_transcript(), Classify content type based on title and text patterns., Enrich a single transcript file.

### Community 6 - "Community 6"
Cohesion: 0.5
Nodes (3): classify_audience(), main(), Determine target audience.
...
Cohesion: 1.0
Nodes (2): extract_concepts(), Extract key concepts from text.
...
Cohesion: 1.0
Nodes (2): generate_summary(), Generate bullet point summary.
...
- **Thin community `Community 8`** (2 nodes): `extract_concepts()`, `Extract key concepts from text.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 9`** (2 nodes): `extract_entities()`, `Extract entities from text.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 10`** (2 nodes): `classify_topic()`, `Classify primary topic.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 11`** (2 nodes): `generate_summary()`, `Generate bullet point summary.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 12`** (2 nodes): `classify_difficulty()`, `Classify difficulty level.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
